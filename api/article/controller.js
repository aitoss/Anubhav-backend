...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://localhost:3000/api/v1/article/verify/${encryptedString}" style="height:31.5pt; width:414.75pt; v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#2d8533"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:16px"><![endif]--><a href="http://localhost:5000/api/v1/article/verify/${encryptedString}" style="-webkit-text-size-adjust: none; text-decoration: none; display: block; color: #ffffff; background-color: #2d8533; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: 60%; width: calc(60% - 2px); border-top: 1px solid #2d8533; border-right: 1px solid #2d8533; border-bottom: 1px solid #2d8533; border-left: 1px solid #2d8533; padding-top: 5px; padding-bottom: 5px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">Approve</span></span></a>
